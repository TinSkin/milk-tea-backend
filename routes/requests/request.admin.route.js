...
router.patch("/:id/approve", verifyToken, checkAdminRole, approveRequest); // PATCH  /api/admin/requests/:id/approve
router.patch("/:id/reject", verifyToken, checkAdminRole, rejectRequest);   // PATCH  /api/admin/requests/:id/reject
