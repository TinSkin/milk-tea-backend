...
const seedStores = async () => {
    try {
        ...
        // ID người dùng thật từ MongoDB
        const userIds = {
            managerHN: "68ce9ab141a2c3f0ec862ab5",
            managerHCM: "68ce9ab241a2c3f0ec862ab8", 
            managerDN: "68ce9ab241a2c3f0ec862abb",
            staffHN1: "68ce9ab241a2c3f0ec862abe",
            staffHN2: "68ce9ab341a2c3f0ec862ac1",
            staffHCM1: "68ce9ab341a2c3f0ec862ac4",
            staffHCM2: "68ce9ab441a2c3f0ec862ac7",
            staffDN1: "68ce9ab441a2c3f0ec862aca",
            staffDN2: "68ce9ab441a2c3f0ec862acd"
        };
    ...
    const allProductIds = allProductsFromDB.map(product => product._id);
    
    console.log(`📦 Found ${allProductIds.length} products in database:`);
    allProductsFromDB.forEach(product => {
        console.log(`   - ${product.name} (${product._id}) - Category: ${product.category?.name}`);
    });
        ...
        const stores = [
            {
                ...
                manager: userIds.managerHN,
                staff: [userIds.staffHN1, userIds.staffHN2],
                products: createProductArray(shuffled.slice(0, perStore)),
                categories: createCategoryArray(categoryIds),
                toppings: createToppingArray(toppingIds),
                operatingHours: {
                    monday: { open: '08:00', close: '22:00' },
            ...
            },
            {
                ...
                manager: userIds.managerHCM,
                staff: [userIds.staffHCM1, userIds.staffHCM2],
                products: createProductArray(shuffled.slice(perStore, perStore * 2)),
                categories: createCategoryArray(categoryIds),
                toppings: createToppingArray(toppingIds),
                operatingHours: {
                    monday: { open: '08:00', close: '22:00' },
            ...
            },
            {
                ...
                manager: userIds.managerDN,
                staff: [userIds.staffDN1, userIds.staffDN2],
                products: createProductArray(shuffled.slice(perStore * 2)),
                categories: createCategoryArray(categoryIds),
                toppings: createToppingArray(toppingIds),
                operatingHours: {
                    monday: { open: '08:00', close: '22:00' },
        ...
        console.log('Đang cập nhật dữ liệu cho cửa hàng...');
        ...
        for (const storeData of stores) {
            ...
            if (!existing) {
                ...
                console.log(`✅ Tạo mới: ${storeData.storeName}`);
                ...
                // CẬP NHẬT store đã tồn tại - chỉ update các trường bạn muốn
                console.log(`🔄 Đang cập nhật: ${existing.storeName}`);
                
                const updateFields = {
                    // CHỈ update các trường này
                    products: storeData.products,
                    categories: storeData.categories,
                    toppings: storeData.toppings,
                    updatedAt: new Date()
                };

                // Optional: Giữ nguyên staff nếu không muốn thay đổi
                // updateFields.staff = storeData.staff;
